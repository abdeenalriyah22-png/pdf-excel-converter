...
# --- 2. قاموس الترجمة (مع الفرنسية) ---
translations = {
    "العربية": {"dir": "rtl", "align": "right", "title": "📊 المحاسب الذكي Pro", "subtitle": "النظام السحابي لمعالجة البيانات", "tab1": "📊 تحويل PDF إلى Excel", "tab2": "🔍 استخراج النصوص (OCR)", "btn_convert": "بدء التحويل", "btn_ocr": "استخراج النص", "motto": "الفصل في الذمة.. الوصل في الأمانة"},
...
# --- 3. نظام التنسيق النيون (النسخة الكاملة والمستقرة) ---
st.markdown(f"""
<style>
...
# --- التذييل ---
st.markdown(f"<div style='text-align:center; padding:20px; color:#00f2fe;'>{lang['motto']}</div>", unsafe_allow_html=True)
