...
translations = {
    "العربية": {
        ...
        "card2_title": "قارئ النصوص والماسح الضوئي", "card2_desc": "استخراج النصوص العربية والإنجليزية والفرنسية والأوردو بدقة كاملة من المستندات المصورة والـ PDF",
    ...
    "English": {
        ...
        "card2_title": "Text Reader & Scanner", "card2_desc": "Extract Arabic, English, French, and Urdu text with full accuracy from scanned documents and images",
        ...
        "status_ocr_loading": "Scanning document and interpreting characters...", "success_convert": "🚀 Conversion completed successfully with highest accuracy!",
        "warning_no_tables": "⚠️ No clear numerical tables detected in this file.", "warning_no_text": "Sorry, no readable characters or text detected in this document.",
    ...
    "اردو": {
        ...
        "card2_title": "ٹیکسٹ ریڈر اور اسكينر", "card2_desc": "اسکین شدہ दस्तावेजات اور تصاویر سے مکمل درستگی کے ساتھ عربی، انگریزی، فرانسیسی اور اردو متن نکالیں",
        "uploader_pdf": "اپنی پی ڈی ایف ٹیبل فائلیں یہاں ڈریگ اور ڈراپ کریں", "uploader_ocr": "انوائس/دستاویز کی تصویر (JPG, PNG) أو اسکین شدہ پی ڈی ایف فائل اپ لوڈ کریں",
        ...
        "warning_no_tables": "⚠️ اس فائل میں کوئی واضح عددی ٹیبل نہیں ملا۔", "warning_no_text": "معذرت، اس دستاویز میں کوئی پڑھنے کے قابل حروف یا متن نہیں ملا۔",
